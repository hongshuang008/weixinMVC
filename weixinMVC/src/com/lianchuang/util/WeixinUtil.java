...
//		return jsonObject;
     ...
     {
         return "{\"button\":[{\"name\":\"菜单看看\",\"sub_button\":[{\"type\":\"click\",\"name\":\"子菜单一一\",\"key\":\"V1001_HELLO_WORLD\"},{\"type\":\"click\",\"name\":\"子菜单一二\",\"key\":\"V1001_GOOD\"}]},{\"name\":\"菜单二\",\"sub_button\":[{\"type\":\"click\",\"name\":\"子菜单二一\",\"key\":\"V1002_HELLO_WORLD\"},{\"type\":\"click\",\"name\":\"子菜单二二\",\"key\":\"V1002_GOOD\"}]},{\"name\":\"菜单三\",\"sub_button\":[{\"type\":\"click\",\"name\":\"子菜单三一\",\"key\":\"V1003_GOOD\"}]}]}";
     }
	 private static void SetMenu(String accesstoken)
     {
		 String postUrl = "https://api.weixin.qq.com/cgi-bin/menu/create?access_token=";
         postUrl = postUrl+ accesstoken;
         String menuInfo = getMenuInfo();
//         PostWebRequest(postUrl, menuInfo);
         String json = httpRequest(postUrl , "POST" , menuInfo);
	...
	public static void main(String[] args) {
		...
		try {
			...
			SetMenu(putil.getProperty("ACCESS_TOKEN"));
